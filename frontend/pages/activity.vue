<template>
  <v-container fluid v-if="can(`web_login_logs_access`)">
    <div>
      <v-card class="mb-5 mt-2 rounded-md background" elevation="0">
        <v-toolbar class="rounded-md background" dense flat>
          ...
          <v-row>
            ...
            <v-col cols="2" class="text-right">
              <div class="px-1 pt-4" style="width: 100%">
                <CustomFilter
