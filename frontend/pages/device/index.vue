  ...
  <div v-if="can(`device_access`)">
    ...
    <v-dialog v-model="responseBox" width="460">
      ...
      <v-card flat class="background">
        <v-alert dense flat dark class="violet">Command Response</v-alert>
        <v-card class="pa-3 background" elevation="0">
          <v-card-text>
            <div
              class="text-center"
    ...
    <v-dialog v-model="uploadedUserInfoDialog" max-width="600px">
      <v-card :loading="loadingDeviceData" class="background">
    ...
    <v-navigation-drawer
      ...
      fixed
    >
      <v-alert class="background darken-1" flat dense>
        <div class="d-flex justify-space-between">
          <div>{{ this.editedIndex == -1 ? "New " : "Edit " }} Device</div>
          <div>
      ...
      <v-form ref="form" v-model="valid" lazy-validation>
        <v-row class="ma-1">
          ...
          <v-col cols="12"  v-if="deviceResponse">
    ...
    <v-card class="mb-5 mt-2 background" elevation="0">
      <v-alert class="rounded-md background darken-1" dense flat>
        <v-row>
          <v-col>
