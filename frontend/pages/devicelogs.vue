<template>
  <div v-if="can(`device_logs_access`)">
    ...
    <v-row>
      <v-col>
        <v-card elevation="0" class="mt-2 background">
          <v-toolbar class="mb-2 background white--text" dense flat>
            <v-toolbar-title>
              ...
              <v-row no-gutters class="align-center pa-3">
                ...
                >
                  ...
                  <span
                    ...
                    "
                  >
                    {{ item.member.title }} {{ item.member.full_name }}
                    <br />
    ...
    <!-- <v-row class="mt-5">
      <v-col cols="12">
        <v-data-table class="background" v-model="ids" item-key="id" :headers="headers" :items="data" :server-items-length="total"
  ...
  data: () => ({
    ...
    headers_table: [
      ...
      },
      {
        ...
        align: "left",
        sortable: true,
        key: "member.show_plan_start_date",
        value: "member.show_plan_start_date", //template name should be match for sorting sub table should be the same
        width: "15%",
        filterable: true,
        filterSpecial: true,
      },
      {
        ...
        align: "left",
        sortable: true,
        key: "member.show_plan_end_date",
        value: "member.show_plan_end_date", //template name should be match for sorting sub table should be the same
        width: "15%",
        filterable: true,
        filterSpecial: true,
      },
      {
        ...
        value: "member.plan.name", //template name should be match for sorting sub table should be the same
        width: "15%",
        filterable: true,
        filterSpecial: true,
      },
