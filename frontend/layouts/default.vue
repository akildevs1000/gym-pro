<template>
  <v-app>
    ...
    >
      ...
      <!-- Mobile: Center Logo -->
      <div
        class="d-flex d-md-none flex-grow-1 justify-center align-center"
        @click="gotoHomePage()"
        style="cursor: pointer"
      >
        <img
      ...
      <div class="d-none d-md-flex flex-grow-1 justify-center align-center">
        <template
          ...
          "
        >
          <v-row align="center" justify="center" class="header-menu-row">
            <v-col
            ...
            >
              <v-btn
                ...
                text
                :elevation="0"
                :color="menuProperties[items.menu]?.selected"
                fill
      ...
      <v-icon class="theme-toggle" @click="toggleDark">
        {{
    ...
    <v-main class="main_bg" style="padding-left: 0">
    ...
    playAudioOnUserInteraction() {
      if (!this.audio) {
        this.audio = new Audio(
          this.$backendUrl.replace("api", "") + "alarm_sounds/alarm-sound1.mp3"
        );
      }
      this.audio.play();
    },
