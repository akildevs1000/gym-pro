...
<body class="container">
            ...
            <td style="border: none;width:33%;text-align:center">
                <div style="text-align:center;height:60px;">
                    @if (env('APP_ENV') !== 'production')
                        <img src="https://backend.mytime2cloud.com/upload/1703668474.png" style="width:100px;">
                    @else
    ...
    <table style="margin-top:30px">
        <tr>
            <td style="text-align: left;padding:5px;">Member</td>
            <td style="text-align: center; padding:5px;">Date</td>
        ...
        @foreach ($attendances as $empID => $attendance)
            @php
                ...
                if ($attendance->member->profile_picture) {
                    $pic =
                        env('BASE_URL') . '/media/employee/profile_picture/' . $attendance->member->profile_picture_raw;
                }
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="border: none;text-align:left;padding-left:8px;">
                                ...
                                <br>
                                <small>{{ $attendance->member->system_user_id }}</small>
                            </td>
                        </tr>
                    </table>
                </td>
