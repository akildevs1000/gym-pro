...
class Attendance extends Model
{
    ...
    {
        return $this->hasMany(AttendanceLog::class, "UserID", "member_id");
    }
    ...
    {
        return $this->belongsTo(Member::class, "member_id", "system_user_id");
    }
